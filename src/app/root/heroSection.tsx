	...
	return (
		<section className="py-24 text-center text-slate-800">
			...
			<h2 className="p-8 text-lg">
				Create confidence pools for your favorite leagues, invite your
				friends, and make every game exciting!
			</h2>
			<LinkButton
				href="/create"
				buttonClassName="border bg-gray-800 text-white tracking-wide"
			>
